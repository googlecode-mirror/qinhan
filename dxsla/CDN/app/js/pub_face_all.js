...
function faceTo51All(a,face_h)
{
	...
	this.init=function(_id,_type)
	{
		...
		document.body.insertAdjacentHTML("beforeEnd",'			<div id="public_51face_box" class="expression" style="display:none;position:absolute;z-index:1198;width:397px;height:297px;background:#fff;border:1px solid #aaa">				<ul id="public_51face_tab" style="background: url(\'' + version_img('exp_03.png') + '\') repeat scroll 0 0 transparent;border-left: 1px solid #CCCCCC;border-right: 1px solid #CCCCCC;height: 33px;overflow:hidden;list-style-type:none;">					<li class="changeli" id="public_51face_tab_def">系统表情</li>				<li>兔斯基</li>					<li>可白</li>					 <li class="close" onclick="'+this.name+'.hide();"><img src="' + version_img('exp_09.jpg') + '"/></li>				</ul>				<div style="clear:both; display:block; height:0;font-size:0/0; overflow:hidden; margin:0 auto; padding:0; border:0; background-color:#fff;"></div>				<div>					<div id="public_51face_img_div" style="width:397px; height:265px; cursor:pointer;cursor:hand;margin:-1px auto 0 auto;" onmousemove="'+this.name+'.moveFaceEvent(event);" onmouseout="'+this.name+'.moveFaceOutEvent(event)">						<img id="public_51face_img" src="http://jjdd01.ivu1314.com/CDN/app/face/mr.png" width="397" height="265" border="0" />					</div>				</div>				<div id="public_51face_select_box" style="display:none;position:absolute;border:1px #f00 solid;width:32px;height:32px;background:transparent;"><div id="public_51face_title_box" style="filter:alpha(opacity=0);-moz-opacity:0;opacity:0;background:red;height:100%;width:100%;"></div></div>				<table id="public_51face_show_left_box" style="display:none;left:2px;position:absolute;top:33px;width:64px!important;height:64px;border:1px #777 solid;background:#fff;" width="64" height="64" border="0" cellspacing="0" cellpadding="0"><tr><td align="center" valign="middle"><img id="public_51face_show_left_img" src="http://jjdd01.ivu1314.com/CDN/app/face/mr/162.gif" /></td></tr></table>				<table id="public_51face_show_right_box" style="display:none;right:2px;position:absolute;top:33px;width:64px!important;height:64px;border:1px #777 solid;background:#fff;" width="64" height="64" border="0" cellspacing="0" cellpadding="0"><tr><td align="center" valign="middle"><img id="public_51face_show_right_img" src="http://jjdd01.ivu1314.com/CDN/app/face/mr/162.gif" /></td></tr></table>			</div>');
		...
		jQuery("li","#public_51face_tab").click(function(h){
			...
			if(d==""){return;}
			b.gID("public_51face_img").src='http://jjdd01.ivu1314.com/CDN/app/face/'+d;
	...
	this.show=function(f,d,z,g,p){
		...
		this.faceInstallIco=function(g,_id,_type)
		{
			...
			if(obj.tagName.toLowerCase() != "textarea") {
				...
				g = g.replace('http://jjdd01.ivu1314.com/CDN/app/face/','');
		...
		this.moveFaceEvent=function(g){
			...
			if(k>0&&c<13)
			{
				...
				//k=m=="face8"?(k+201):k;
				k=100+k;
				var f='http://jjdd01.ivu1314.com/CDN/app/face/'+m+"/"+(k-1)+".gif";
				this.onimg=f;
				if(c<4)
				{
